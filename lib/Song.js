...
Song.prototype.validatePattern = function (pattern) {
  var trimmedPattern = pattern.replace(/[^.|x]/g, '');
  if (trimmedPattern.length === 0) { throw new TypeError('No Valid Pattern Characters'); }
  return padPattern(trimmedPattern);
};
